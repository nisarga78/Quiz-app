...
<%@page import="java.io.PrintWriter"%>
    ...
    <div class="container">
    <%! int count=0; %>
    <h2 class="my-3">Add Computer Network Quiz Question <span class="text-danger">!!</span><%=" "+count %></h2>
	    <div class="row">
	    	<form action="../addcnsql" method="post">
			  <div class="mb-3 m-2">
                		...
                		<div class="row mt-4 shadow">
                			...
                			<%
								try{
						            ...
						            ResultSet rs = stmt1.executeQuery("select * from addcn"); 
							             ...
							             {  
							               ...
							               %>
											    ...
											    <tr>
												      ...
												      <td class="text-center"> <a href="http://localhost:2020/1NH21MC056/deleteitemcn?id=<% out.print(id); %>" class="btn btn-danger"> Delete </a> </td>
											    </tr>
							               <%   
