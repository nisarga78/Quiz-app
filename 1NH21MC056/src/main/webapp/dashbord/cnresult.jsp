        ...
        <div class="d-flex justify-content-center row">
            <div class="col-md-10 col-lg-10">
                <div class="border">
                    ...
                    <form action="../cnquizsubmit" method="get">
                    ...
                    try{
					    ...
					    ResultSet rs = stmt1.executeQuery("SELECT addcn.id,addcn.qf1,addcn.of1,addcn.of2,addcn.of3,addcn.of4, addcn.af1, result.question, result.uans FROM result INNER JOIN addcn;");
