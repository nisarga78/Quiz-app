                ...
                <div class="border">
                    <div class="question bg-white p-3 border-bottom">
                        <div class="d-flex flex-row justify-content-between align-items-center mcq">
                            <h4>MCQ Quiz <span= class="text-primary">Answer !!</span></span></h4><span class="text-danger">Java Programming</span>
                        </div>
                    </div>
                    ...
                    try{
					    ...
					    ResultSet rs = stmt1.executeQuery("SELECT addjava.id,addjava.qf1,addjava.of1,addjava.of2,addjava.of3,addjava.of4, addjava.af1, result.question, result.uans FROM result INNER JOIN addjava;"); 
