...
<%@page import="java.io.PrintWriter"%>
    ...
    <div class="container">
    <%! int count=0; %>
    <h2 class="my-3">Add Java Quiz Question <span class="text-danger">!!</span><%=" "+count %></h2>
	    <div class="row">
	    	<form action="../addjavasql" method="post">
			  <div class="mb-3 m-2">
                		...
                		<div class="row mt-4 shadow">
                			...
                			<%
								try{
						            ...
						            ResultSet rs = stmt1.executeQuery("select * from addjava"); 
							             ...
							             {  
							               ...
							               %>
											    ...
											    <tr>
												      ...
												      <td class="text-center"> <a href="http://localhost:2020/1NH21MC056/deleteitemjava?id=<% out.print(id); %>" class="btn btn-danger"> Delete </a> </td>
											    </tr>
							               <%   
