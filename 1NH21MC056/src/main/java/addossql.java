...
@WebServlet("/addossql")
public class addossql extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			String q1 = String.format("INSERT INTO `addos` (`id`, `qf1`, `of1`, `of2`, `of3`, `of4`, `af1`) VALUES (NULL, '%s', '%s', '%s', '%s', '%s', '%s');",qf1,of1,of2,of3,of4,af1);
			int send1 = stmt.executeUpdate(q1);
			 ...
			 if (send1 >0) {
		    	 ...
		    	 response.sendRedirect("http://localhost:2020/1NH21MC056/dashbord/addosmcq.jsp?msg=fail");
