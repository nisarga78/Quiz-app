...
@WebServlet("/osquizsubmit")
public class osquizsubmit extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		response.sendRedirect("http://localhost:2020/1NH21MC056/dashbord/osresult.jsp?msg=success");
