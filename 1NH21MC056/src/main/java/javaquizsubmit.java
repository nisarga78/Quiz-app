...
@WebServlet("/javaquizsubmit")
public class javaquizsubmit extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
   
    public javaquizsubmit() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("http://localhost:2020/1NH21MC056/dashbord/javaresult.jsp?msg=success");
